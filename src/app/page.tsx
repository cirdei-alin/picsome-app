...
export default function HomePage() {
  ...
  return (
    <main className="mx-auto w-full max-w-7xl flex-1 px-5 py-8">
      <section className="mb-9 overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 shadow-2xl shadow-black/30 backdrop-blur-xl md:p-8">
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            <h1 className="text-4xl font-black tracking-tight text-white md:text-5xl">
              Discover visuals that {" "}
            ...
            <p className="mt-4 max-w-xl text-base leading-7 text-slate-300">
              Explore curated photography, save your favorites and build your own 
              collection through a modern and intuitive experience.
            </p>
